...
export const metadata: Metadata = {
  title: "Bộ sưu tập",
  description: "Xem nhanh những hướng quà tặng nổi bật trước khi chọn mẫu và gửi yêu cầu tư vấn.",
};
      ...
      <main className="px-5 pb-16 pt-10 sm:px-6 lg:px-8 lg:pt-14">
        <section className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <p className="text-sm tracking-[0.22em] text-[#ead3b4] uppercase">Bộ sưu tập</p>
            <h1 className="mt-3 text-4xl font-semibold tracking-[-0.03em] text-white sm:text-5xl">
              Một vài gợi ý để bạn chọn mẫu nhanh hơn.
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-8 text-stone-400">
              Mỗi bộ sưu tập là một hướng quà tặng rõ ràng. Chọn mẫu phù hợp trước, phần còn lại đội ngũ sẽ tư vấn cùng bạn.
            </p>
          </div>
